%% Tomaso Muzzu - UCL - 09 April 2019
...
if exist([ProjectFolder{1} filesep 'AllDataHere.mat'], 'file') == 2
    ...
    if ~Skip
        ...
        save([ProjectFolder{1} filesep 'AllDataHereCTRL.mat'], 'ProjectDataCTRL', '-v7.3');
    else
        fprintf('Recordings already saved. File already up to date.\n')
    end
else % if file does not exit, create new file
    ProjectData = Array;
    save([ProjectFolder{1} filesep 'AllDataHereCTRL.mat'], 'ProjectData', '-v7.3');
end
